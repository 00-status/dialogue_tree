...
describe('useAvailableSections', () => {
    it('should all sections that have their prerequisites met', () => {
        const { result } = renderHook(() => useAvailableSections('Banana', []));
    ...
    it('should NOT return the current section', () => {
        const { result } = renderHook(() => useAvailableSections(TEST_DESCRIPTION_ONE, []));
